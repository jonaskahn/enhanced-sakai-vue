...
<template>
    <div>
        <Toast />
        <Toast draggable="false" error-icon="pi pi-times-circle" group="desktop" info-icon="pi pi-info-circle"
               position="top-right" success-icon="pi pi-check-circle" warn-icon="pi pi-exclamation-circle" />
        <Toast draggable="false" error-icon="pi pi-times-circle" group="mobile" info-icon="pi pi-info-circle"
               position="top-center" success-icon="pi pi-check-circle" warn-icon="pi pi-exclamation-circle" />
