        ...
        <div id="home" class="landing-wrapper overflow-hidden">
            <div class="py-6 px-6 mx-0 md:mx-12 lg:mx-20 lg:px-20 flex items-center justify-between relative lg:static">
                <a class="flex items-center" href="#">
                    <svg class="h-12 mr-2" fill="none" viewBox="0 0 54 40" xmlns="http://www.w3.org/2000/svg">
                        <path
                            clip-rule="evenodd"
                    ...
                    <span
                        class="text-surface-900 dark:text-surface-0 font-medium text-2xl leading-normal mr-20">SAKAI</span>
                </a>
                <Button
            ...
            >
                <div class="mx-6 md:mx-20 mt-0 md:mt-6">
                    <h1 class="text-6xl font-bold text-gray-900 leading-tight"><span class="font-light block">Eu sem integer</span>eget
                        magna fermentum</h1>
                    ...
                    <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 lg:pb-8 mt-6 lg:mt-0">
                        ...
                        >
                            <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                                ...
                                <span
                                    class="text-surface-600 dark:text-surface-200">Posuere morbi leo urna molestie.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 lg:pb-8 mt-6 lg:mt-0">
                        ...
                        >
                            <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                                ...
                                <span
                                    class="text-surface-600 dark:text-surface-200">Nulla malesuada pellentesque elit.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 lg:pb-8 mt-6 lg:mt-0">
                        ...
                        >
                            <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                                ...
                                <span
                                    class="text-surface-600 dark:text-surface-200">Condimentum lacinia quis vel eros.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg-4 mt-6 lg:mt-0">
                        ...
                        >
                            <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                                ...
                                <span
                                    class="text-surface-600 dark:text-surface-200">Neque egestas congue quisque.</span>
                            </div>
                        </div>
                    </div>
            ...
            <div id="highlights" class="py-6 px-6 lg:px-20 mx-0 my-12 lg:mx-20">
                ...
                <div class="grid grid-cols-12 gap-4 mt-20 pb-2 md:pb-20">
                    <div class="flex justify-center col-span-12 lg:col-span-6 bg-purple-100 p-0 order-1 lg:order-none"
                        ...
                        <img alt="mockup mobile" class="w-11/12" src="/demo/images/landing/mockup.svg" />
                    </div>
                ...
                <div class="grid grid-cols-12 gap-4 my-20 pt-2 md:pt-20">
                    ...
                    <div class="flex justify-end order-1 sm:order-2 col-span-12 lg:col-span-6 bg-yellow-100 p-0"
                         style="border-radius: 8px">
                        <img alt="mockup" class="w-11/12" src="/demo/images/landing/mockup-desktop.svg" />
                    </div>
                </div>
            </div>
                        ...
                        <div class="grid grid-cols-12 gap-8 text-center md:text-left">
                            <div class="col-span-12 md:col-span-3">
                                <h4 class="font-medium text-2xl leading-normal mb-4 text-surface-900 dark:text-surface-0">
                                    Company</h4>
                                <a class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 dark:text-surface-100">About
                                    Us</a>
                            ...
                            <div class="col-span-12 md:col-span-3">
                                <h4 class="font-medium text-2xl leading-normal mb-4 text-surface-900 dark:text-surface-0">
                                    Resources</h4>
                                <a class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 dark:text-surface-100">Get
                                    Started</a>
                            ...
                            <div class="col-span-12 md:col-span-3">
                                ...
                                <a class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 dark:text-surface-100">Events<img
                                    class="ml-2" src="/demo/images/landing/new-badge.svg" /></a>
                            ...
                            <div class="col-span-12 md:col-span-3">
                                <h4 class="font-medium text-2xl leading-normal mb-4 text-surface-900 dark:text-surface-0">
                                    Legal</h4>
                                <a class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 dark:text-surface-100">Brand
                                    Policy</a>
                                <a class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 dark:text-surface-100">Privacy
                                    Policy</a>
